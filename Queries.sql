...
UNION SELECT '' AS empty, '' AS empty2, 'TOTAL' AS total, SUM(c.credit_hours) AS total_credits, SUM(sg.GPA * c.credit_hours)/SUM(c.credit_hours) AS GPA
...
#additional query 2
Select the building, then in that building it will tell you the room that have capacity > 50
